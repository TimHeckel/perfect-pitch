...
await page.waitForTimeout(18_250);
await page.close();
await context.close();
await browser.close();
...
const guitar = join(root, 'static', 'chords', 'guitar-strummed', 'c4f4a4_yellow.mp3');
...
execFileSync('ffmpeg', [
  ...
  '[2:a]atrim=0:2.3,volume=0.62,afade=t=out:st=1.7:d=0.5,adelay=9600:all=1[guitar];' +
  'anullsrc=r=48000:cl=stereo,atrim=0:18[silence];' +
